...
public class CinemaInitServiceImpl implements ICinemaInitService{
	...
	public void initVilles() {
		Stream.of("Casablanca","Laayoune","Rabat","Tanger").forEach(nameVille->{
	...
	public void initFilms() {
		...
		Stream.of("Game of thrones","Venom","Spider man","IRON Man", "Cat Women","Green Book","le parin","le seigneur des anneaux")
		.forEach(f->{
			Film film=new Film();
			film.setTitre(f);
